#issue with importing mnist database 
#import os
...
from cleverhans.tf2.attacks import projected_gradient_descent, fast_gradient_method
...
def main(_):
  # Load training and test data
  print("a")
  print(tfds.is_dataset_on_gcs('mnist'))
  print("b")
  data = ld_mnist()
  model = Net()
